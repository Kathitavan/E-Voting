  ...
  useEffect(() => {
    const handleKey = (e) => {
      if (e.ctrlKey && e.shiftKey && e.key.toLowerCase() === "a") {
        ...
        if (pw === "admin123") { setAdminAuth(true); setStep("dashboard"); }
        ...
        <div className="navbar__brand">
          <div className="navbar__emblem">
            <img
              ...
              onError={(e) => { e.target.replaceWith(Object.assign(document.createElement("span"), { textContent: "🗳️", className: "navbar__logo-fallback" })); }}
            />
