...
const ERRORS = {
  ...
  500: {
    ...
    desc: "The server encountered an unexpected condition and could not complete your request.",
    icon: "⚙️",
    accent: "red",
  ...
  502: {
    code: "502",
    title: "Bad Gateway",
    desc: "The server received an invalid response from the upstream backend.",
    icon: "🌐",
    accent: "red",
  ...
  503: {
    ...
    desc: "The server is temporarily unable to handle your request due to maintenance or overload.",
    icon: "🛠️",
    accent: "saffron",
  ...
  504: {
    ...
    desc: "The server did not receive a timely response from the upstream backend.",
    icon: "⏱️",
    accent: "saffron",
  ...
  offline: {
    code: "---",
    title: "No Connection",
    desc: "You appear to be offline. Please check your internet or network connection.",
    icon: "📡",
    accent: "ashoka",
...
export default function ErrorPage({ code = 404, onRetry, onHome }) {
  ...
  /* Animated ellipsis for description */
  useEffect(() => {
  ...
  return (
    <div className="ep-root" style={{
      ...
      {/* Tricolor stripe */}
      <div className="ep-stripe"><div className="ep-s"/><div className="ep-w"/><div className="ep-g"/></div>
      ...
      <div className="ep-wrap">
        ...
        <div className="ep-text">
          ...
          <p className="ep-desc">{err.desc}</p>
        </div>

        {/* ── Tricolor divider ── */}
        <div className="ep-divider">
          <div className="ep-div-s"/><div className="ep-div-w"/><div className="ep-div-g"/>
        </div>
      ...
      <div className="ep-stripe ep-stripe--btm"><div className="ep-s"/><div className="ep-w"/><div className="ep-g"/></div>
    </div>
  );
}

/* ── Named exports for each error ── */
export function Error404(props)    { return <ErrorPage code={404}     {...props} />; }
export function Error403(props)    { return <ErrorPage code={403}     {...props} />; }
export function Error401(props)    { return <ErrorPage code={401}     {...props} />; }
export function Error500(props)    { return <ErrorPage code={500}     {...props} />; }
export function Error502(props)    { return <ErrorPage code={502}     {...props} />; }
export function Error503(props)    { return <ErrorPage code={503}     {...props} />; }
export function Error504(props)    { return <ErrorPage code={504}     {...props} />; }
export function ErrorOffline(props){ return <ErrorPage code="offline" {...props} />; }